...
namespace LostForest.Phase2.Tiles
{
    ...
    public sealed class ForestFillProfile
    {
        ...
        {
            return new ForestFillProfile(101, 10, 7.5f, 24f, 7f, new Vector2(7f, 12f), new Vector2(0.45f, 0.85f));
        }

        public static ForestFillProfile CreateSparsePrototype(int seedSalt)
        {
            return new ForestFillProfile(seedSalt, 16, 6.75f, 10f, 6f, new Vector2(8f, 14f), new Vector2(0.45f, 0.95f));
        }

        public static ForestFillProfile CreateNormalPrototype(int seedSalt)
        {
            return new ForestFillProfile(seedSalt, 24, 5.75f, 8f, 5f, new Vector2(9f, 16f), new Vector2(0.5f, 1.05f));
        }

        public static ForestFillProfile CreateDensePrototype(int seedSalt)
        {
            return new ForestFillProfile(seedSalt, 36, 4.75f, 6f, 4f, new Vector2(10f, 18f), new Vector2(0.55f, 1.15f));
        }
